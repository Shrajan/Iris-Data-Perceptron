...
'''
    ...
    File Name   : Perceptron Versicolor without learning rate.
    ...
    Program Description:
        ...
        versicolor vs non-versicolor. This program does not implement the 
        learning rate. 
...
# The program is training for Versicolor vs Non-Versicolor
